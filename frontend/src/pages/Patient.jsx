...
import { FaSearch, FaPlus, FaEye, FaTimes, FaUser, FaPhone, FaEnvelope, FaMapMarkerAlt, FaSpinner } from 'react-icons/fa';
...
const Patient = () => {
  ...
  const handleAddPatient = () => {
    if (!newPatient.name || !newPatient.age || !newPatient.contact || !newPatient.email || !newPatient.gender) {
      ...
      <div className="bg-white shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Patient Records Dashboard</h1>
            </div>
            <button 
        ...
        {filteredPatients.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredPatients.map((patient) => (
              <div key={patient.id} className="bg-white rounded-lg shadow-sm p-6 border hover:shadow-md">
